/**
	@file
	@brief Common definitions for the CC printer driver rendering plugin
...
#ifndef _CCPSRENDERING_H
#define _CCPSRENDERING_H
...
#define CCPSRENDERING_SIGNATURE   'CCPS'
#define CCPSRENDERING_VERSION     0x00000001L

...
typedef struct _tagXMLEntitys : public std::vector<XENTITY>
{
	...
	std::tstring::size_type Ref2Entity( LPCTSTR estr, LPTSTR str, int len );
	std::tstring::size_type Entity2Ref( LPCTSTR str, LPTSTR estr, int estrlen );
	std::tstring Ref2Entity( LPCTSTR estr );
	std::tstring Entity2Ref( LPCTSTR str );	
	std::tstring::size_type Ref2Entity( LPCTSTR estr, std::tstring& str, int elen );
	std::tstring::size_type Entity2Ref( LPCTSTR str, std::tstring& estr, int len );
...
typedef struct _tagXMLNode
{
	...
	// modify DOM 
	std::tstring::size_type	GetChildCount();

...
#ifndef _CCLICENSEWIZJURISDICTIONPAGE_H_
#define _CCLICENSEWIZJURISDICTIONPAGE_H_

#include "CCLicenseWizBasePage.h"
#include "resource.h"

/**
    @brief License wizard: Jurisdiction selection page
*/
class CCLicenseWizJurisdictionPage : public CCLicenseWizBasePage
{
public:
	// Ctor
	/**
	...
	*/
	CCLicenseWizJurisdictionPage(IPrintOemDriverUI* pHelper, LicenseInfo* pInfo) : CCLicenseWizBasePage(IDD_LICENSEPAGE_JURISDICTION, pHelper, pInfo) {};
...
#endif   //#define _CCLICENSEWIZJURISDICTIONPAGE_H_

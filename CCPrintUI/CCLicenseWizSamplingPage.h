...
#ifndef _CCLICENSEWIZSAMPLINGPAGE_H_
#define _CCLICENSEWIZSAMPLINGPAGE_H_

#include "CCLicenseWizBasePage.h"
#include "resource.h"

/**
    @brief License Wizard: sampling type page
*/
class CCLicenseWizSamplingPage : public CCLicenseWizBasePage
{
public:
	// Ctor
	/**
	...
	*/
	CCLicenseWizSamplingPage(IPrintOemDriverUI* pHelper, LicenseInfo* pInfo) : CCLicenseWizBasePage(IDD_LICENSEPAGE_SAMPLING, pHelper, pInfo) {};
...
#endif   //#define _CCLICENSEWIZSAMPLINGPAGE_H_
